...
const routes: Routes = [
  ...
  // Evaluations, Reviews & Badges
  { path: 'evaluations', loadChildren: () => import('./evaluation/evaluation.module').then(m => m.EvaluationModule) },
  { path: 'badges', loadChildren: () => import('./badge/badge.module').then(m => m.BadgeModule), canActivate: [AdminGuard] },
