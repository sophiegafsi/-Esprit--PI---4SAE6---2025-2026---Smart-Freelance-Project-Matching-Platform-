...
export class ProfileClientComponent implements OnInit {
    ...
    clientView = {
        name: '',
        image: 'https://ui-avatars.com/api/?name=Client&size=200&background=6366f1&color=fff&rounded=true',
        email: '',
        country: '',
        birthDate: ''
    };
    ...
    updateView(user: any): void {
        ...
        this.clientView.image = user.imageUrl || `https://ui-avatars.com/api/?name=${initials}&size=200&background=6366f1&color=fff&rounded=true`;
    }
