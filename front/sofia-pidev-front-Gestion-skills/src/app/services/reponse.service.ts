...
export class ReponseService {
  private apiUrl = 'http://localhost:8081/reclamation/api/reclamations';
  private moderationUrl = 'http://localhost:8081/reclamation/api/reponses';
  private sentimentUrl = 'http://localhost:8081/reclamation/api/sentiment';
