...
public class Task {
    ...
    public Task(Long id, String title, String description, LocalDate taskDate, LocalTime startTime, LocalTime endTime,
                TaskPriority priority, TaskStatus status, Planning planning) {
        this.id = id;
        this.title = title;
