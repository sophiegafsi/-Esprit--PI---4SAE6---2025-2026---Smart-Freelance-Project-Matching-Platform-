...
This folder versions the Jenkins and monitoring resources used with the `Fares-back` branch.

Active service pipeline in this branch:

- `devops/jenkins/Jenkinsfile.skills-service`
...
- For Jenkins, you can use either the root `Jenkinsfile` or `devops/jenkins/Jenkinsfile.skills-service`.
