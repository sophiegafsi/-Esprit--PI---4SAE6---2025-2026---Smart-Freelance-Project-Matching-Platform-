...
public class ProjetController {
    ...
    // Lister les projets par client
    @GetMapping("/client/{clientId}")
    public ResponseEntity<List<Projet>> listerProjetsParClient(@PathVariable java.util.UUID clientId) {
        List<Projet> projets = projetService.listerProjetsParClient(clientId);
        return new ResponseEntity<>(projets, HttpStatus.OK);
    }
