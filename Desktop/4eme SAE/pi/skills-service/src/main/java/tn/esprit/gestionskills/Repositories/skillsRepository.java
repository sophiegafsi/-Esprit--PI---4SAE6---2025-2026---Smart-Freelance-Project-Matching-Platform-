...
public interface  skillsRepository extends JpaRepository<skills, Long> {
    Page<skills> findByUserIdAndNameContainingIgnoreCase(String userId, String q, Pageable pageable);

    Page<skills> findByUserIdAndNameContainingIgnoreCaseAndLevel(String userId, String q, SkillLevel level, Pageable pageable);
    ...
    java.util.List<skills> findByUserId(String userId);
